...
def parse_cli_args(args):
    """Parse a CLI args list and return a dict of extracted values.
    Wraps the main argparse setup so tests can call it directly.
    ...
    p.add_argument("--mode", default="evolve")
