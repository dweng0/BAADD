...
def test_orchestrate_sorts_results_by_planned_order():
    ...
    results = [
        {"scenario": "Scenario C", "commits": 1, "tests_pass": True, "has_marker": True},
        {"scenario": "Scenario A", "commits": 1, "tests_pass": True, "has_marker": True},
        {"scenario": "Scenario B", "commits": 1, "tests_pass": True, "has_marker": True},
    ]
