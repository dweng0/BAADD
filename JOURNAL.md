...
Coverage: 352/432 scenarios.


## 2026-04-30 13:59 — Orchestrator session

Ran 1 agents across 1 round(s) (max 1 concurrent per round). Total agent time: 653s.

**Merged (1):** sessions.jsonl is created if it does not exist
...
**Merged (2):** Always install agent dependencies, Setup Go dependencies
**Failed (1):** Skip unknown language gracefully

Coverage: 171/347 scenarios.


## 2026-04-28 13:14 — Orchestrator session

Ran 3 agents across 1 round(s) (max 3 concurrent per round). Total agent time: 454s.
...
**Failed (4):** Missing anthropic package error, Exit with error code when scenarios uncovered, CUSTOM_MODEL required for custom provider without --model, No provider detected error message
...
**Failed (2):** Parse YAML frontmatter from BDD.md, Handle missing frontmatter gracefully
